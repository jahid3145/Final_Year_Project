"""a_stock_price_prediction_modelURL Configuration
...
from a_stock_price_prediction_model import settings
...
urlpatterns = [
    ...
    url(r'^ratings/$', remoteuser.ratings, name="ratings"),
    url(r'^Predict_Investor_Sentiment_Type/$', remoteuser.Predict_Investor_Sentiment_Type, name="Predict_Investor_Sentiment_Type"),
    ...
    url(r'Delete_Remote_User/(?P<user_id>\d+)/$', serviceprovider.Delete_Remote_User, name="Delete_Remote_User"),
    ...
    url(r'^View_Prediction_Of_Investor_Sentiment_Type_Ratio/$', serviceprovider.View_Prediction_Of_Investor_Sentiment_Type_Ratio, name="View_Prediction_Of_Investor_Sentiment_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Investor_Sentiment_Type/$', serviceprovider.View_Prediction_Of_Investor_Sentiment_Type, name="View_Prediction_Of_Investor_Sentiment_Type"),
