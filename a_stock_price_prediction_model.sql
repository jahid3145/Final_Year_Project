...
--
-- Host: localhost
-- Generation Time: Oct 05, 2023 at 11:49 AM
...
--
-- Database: `a_stock_price_prediction_model`
--
CREATE DATABASE IF NOT EXISTS `a_stock_price_prediction_model` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_stock_price_prediction_model`;
...
('3g55mdldknlbqgij2wgzos5clld6dwjk', 'eyJ1c2VyaWQiOjF9:1qlTam:_5oJrXFlTUFrA6-6GBRXNF_TMJcGnUy_6iWKbKvFLHE', '2023-10-11 12:24:36.501648'),
...
('99vzufl252kq6w2blamkax51xm7oc4z8', 'eyJ1c2VyaWQiOjF9:1odRhY:5XnmKWQ_7xLz8l31_wTUMJA_Avbv9RmObGZ8LKioy0c', '2022-10-12 07:41:52.265773'),
...
('mkler0unerjax1nmtklzca8radudywgu', 'eyJ1c2VyaWQiOjJ9:1odUga:ZJBza3bcyEIkHbpDMBKYTPqQlIP-7H3p0Nn92Vvlf88', '2022-10-12 10:53:04.745713'),
...
('wm3pi3ux4esvgxpuu4cfxn6yrrmr1b8h', 'eyJ1c2VyaWQiOjJ9:1qlUrY:XJOFNRF-POeHektPNTRPAF9pXR9XnlG9HKb06-kRKBQ', '2023-10-11 13:46:00.290686'),
...
(1, 'Gokul', 'Gokul123@gmail.com', 'Gokul', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(17, 'Deep Neural Network (DNN)', '91.81669394435352'),
(18, 'SVM', '89.68903436988543'),
(19, 'Logistic Regression', '92.3076923076923'),
(20, 'Decision Tree Classifier', '90.99836333878886'),
(21, 'KNeighborsClassifier', '93.28968903436989'),
(22, 'Gradient Boosting Classifier', '92.14402618657938');
...
--
-- Table structure for table `remote_user_predict_investor_sentiment`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_investor_sentiment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Investor_Age` varchar(300) NOT NULL,
  `Investor_Gender` varchar(300) NOT NULL,
  `PDate` varchar(300) NOT NULL,
  `Stock_Text` varchar(30000) NOT NULL,
...
--
-- Dumping data for table `remote_user_predict_investor_sentiment`
--

INSERT INTO `remote_user_predict_investor_sentiment` (`id`, `Investor_Age`, `Investor_Gender`, `PDate`, `Stock_Text`, `Stock_Name`, `Company_Name`, `Prediction`) VALUES
(1, '30', 'M', '2022-09-29 21:58:00+00:00', '"Tomorrow, Tesla, $TSLA, AI day 2 is ongoing.\r\n\r\nUnusual Whales is bringing some Tesla experts to discuss what to expect and $TSLA generally.\r\n\r\nJoin below to prepare before the event at 6:55PM EST:\r\n\r\nhttps://t.co/hObh7OdVs5"\r\n', 'TSLA', 'Tesla, Inc.', 'Uptrends'),
(2, '53', 'M', '2022-09-29 22:23:28+00:00', '"50 likes for some $SPY $TSLA charts to study!\r\n\r\nâ¤ï¸"\r\n', 'TSLA', 'Tesla, Inc.', 'Uptrends'),
(3, '59', 'M', '2022-09-29 21:00:25+00:00', 'The irony is so thick you can cut it with a knife. @Tesla https://t.co/8CihPdpns7\r\n', 'TSLA', 'Tesla, Inc.', 'Downtrends'),
(4, '34', 'M', '2022-09-29 06:27:03+00:00', '"""With Hardware 4 we will have a next generation camera. \r\n\r\nBut I have to say, we have not reached the limit of the current cameras. I''m confident we can get Full Self-Driving safer than a human with the existing cars and the existing cameras"" â€” @elonmusk $TSLA https://t.co/idYDw4FX9p"\r\n', 'TSLA', 'Tesla, Inc.', 'Uptrends');
